...
function Player(props) {
  ...
  const { speed, playing, currentSong: immutableCurrentSong, currentIndex, playList: immutablePlayList, mode, sequencePlayList: immutableSequencePlayList, fullScreen } = props
...
const mapDispatchToProps = (dispatch) => ({
  togglePlayingDispatch: (data) => dispatch(changePlayingState(data)),
  toggleFullScreenDispatch: (data) => dispatch(changeFullScreen(data)),
  togglePlayListDispatch: (data) => dispatch(changeShowPlayList(data)),
  changeCurrentIndexDispatch: (index) => dispatch(changeCurrentIndex(index)),
  changeCurrentDispatch: (data) => dispatch(changeCurrentSong(data)),
  changeModeDispatch: (data) => dispatch(changePlayMode(data)),
  changePlayListDispatch: (data) => dispatch(changePlayList(data)),
  changeSpeedDispatch: (data) => dispatch(changeSpeed(data)),
})

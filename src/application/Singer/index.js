...
import { getSingerInfo } from '@/store/singer/actionCreators'
      ...
      <Container>
        ...
        <SongListWrapper ref={songScrollWrapper} play={songsCount}>
          <Scroll onScroll={handleScroll} ref={songScroll}>
            <SongsList songs={songs} showCollect={false} usePageSplit={false} musicAnimation={musicAnimation}></SongsList>
          </Scroll>
        </SongListWrapper>
        {loading ? (
...
const mapDispatchToProps = (dispatch) => ({
  getSingerDataDispatch: (id) => dispatch(getSingerInfo(id)),
})
